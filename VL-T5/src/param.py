...
def parse_args(parse=True, **optional_kwargs):
    ...
    parser.add_argument("--num_answers", type=int, default=3129)
    parser.add_argument("--num_answers_tduic", type=int, default=1589)
    ...
    parser.add_argument("--l_mfa", type=int, default=5)
    parser.add_argument("--dis", type=str, default='cos')
